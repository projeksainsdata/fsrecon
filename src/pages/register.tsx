...
const Register = () => {
    ...
    return (
        <div>
            ...
            <div className="relative flex min-h-screen items-center justify-center bg-gradient-to-r from-yellow-500 to-stone-800 bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
